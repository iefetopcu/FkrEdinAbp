...
{
    public abstract class FikirEdinWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FikirEdinWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FikirEdinWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FikirEdinDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FikirEdinDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FikirEdinDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FikirEdinDbContext, Task<T>> func)
        {
            T result;
